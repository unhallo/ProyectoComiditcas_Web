            ...
            <section class="content">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-12">
                                <h1 class="m-0" style= "color: #fac564;">Consulta de Souvenirs</h1>
                                <br/>
                                ...
                                <div>
                                    <a class="btn btn-primary" href="registrarSouvenirs.php">
                                        <i class="fa fa-plus" style="margin-right:5px"> </i>Registrar
                                    </a>
                                </div>
                                <br/>

                                <table style= "color: #fac564;" id="tablaSouvenirs" class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th>Nombre</th>
                                            <th>Precio</th>
