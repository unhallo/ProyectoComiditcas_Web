<?php include_once 'layoutInterno.php';
      ...
      $datos = ConsultarSouvenir($_GET["q"]);
?>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input id="txtIdSouvenir" name="txtIdSouvenir" type="hidden" value="<?php echo $datos["IdSouvenir"] ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                            <button type="submit" id="btnActualizarSouvenir" name="btnActualizarSouvenir"
